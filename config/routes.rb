...
#     api_v1_category_sub_category_products GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products(.:format)          api/v1/products#index {:format=>"json", :locale=>/en|ar/}
#                                           POST       (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products(.:format)          api/v1/products#create {:format=>"json", :locale=>/en|ar/}
#  new_api_v1_category_sub_category_product GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/new(.:format)      api/v1/products#new {:format=>"json", :locale=>/en|ar/}
# edit_api_v1_category_sub_category_product GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/:id/edit(.:format) api/v1/products#edit {:format=>"json", :locale=>/en|ar/}
#      api_v1_category_sub_category_product GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/:id(.:format)      api/v1/products#show {:format=>"json", :locale=>/en|ar/}
#                                           PATCH      (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/:id(.:format)      api/v1/products#update {:format=>"json", :locale=>/en|ar/}
#                                           PUT        (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/:id(.:format)      api/v1/products#update {:format=>"json", :locale=>/en|ar/}
#                                           DELETE     (/:locale)/api/v1/categories/:category_id/sub_categories/:sub_category_id/products/:id(.:format)      api/v1/products#destroy {:format=>"json", :locale=>/en|ar/}
...
#         edit_api_v1_category_sub_category GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:id/edit(.:format)                           api/v1/sub_categories#edit {:format=>"json", :locale=>/en|ar/}
#              api_v1_category_sub_category GET        (/:locale)/api/v1/categories/:category_id/sub_categories/:id(.:format)                                api/v1/sub_categories#show {:format=>"json", :locale=>/en|ar/}
#                                           PATCH      (/:locale)/api/v1/categories/:category_id/sub_categories/:id(.:format)                                api/v1/sub_categories#update {:format=>"json", :locale=>/en|ar/}
#                                           PUT        (/:locale)/api/v1/categories/:category_id/sub_categories/:id(.:format)                                api/v1/sub_categories#update {:format=>"json", :locale=>/en|ar/}
#                                           DELETE     (/:locale)/api/v1/categories/:category_id/sub_categories/:id(.:format)                                api/v1/sub_categories#destroy {:format=>"json", :locale=>/en|ar/}
